...
# Paths
video_dir = r"D:\data_set"
output_dir = r"D:\signcsv"
...
# Get all .mov files in video_dir
video_files = [f for f in os.listdir(video_dir) if f.lower().endswith(".mov")]

for video_file in video_files:
    video_path = os.path.join(video_dir, video_file)
    csv_filename = os.path.splitext(video_file)[0].lower() + ".csv"
    csv_path = os.path.join(output_dir, csv_filename)

    print(f"Processing {video_file} -> {csv_filename}")
